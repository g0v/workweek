<template>
  ...
  <div class="container">
    ...
    <div class="input">
      <label>週一 <input type="number" class="workhours" v-model="workhours[0]"></label>
      <label>週二 <input type="number" class="workhours" v-model="workhours[1]"></label>
      <label>週三 <input type="number" class="workhours" v-model="workhours[2]"></label>
      <label>週四 <input type="number" class="workhours" v-model="workhours[3]"></label>
      <label>週五 <input type="number" class="workhours" v-model="workhours[4]"></label>
      <label>週六 <input type="number" class="workhours" v-model="workhours[5]"></label>
      <label>週日 <input type="number" class="workhours" v-model="workhours[6]"></label>
    </div>
    <div class="row">
      <div class="col-md-4">
        <h3>勞基法現行版本</h3>
